...
__kernel void filterFrame_2d_int_quarterCtu(__global short *referenceFrame, __global short *filteredFrame, const int frameWidth, const int frameHeight, const int kernelIdx, const int rep){
...
__kernel void filterFrame_2d_int_5x5_quarterCtu(__global short *referenceFrame, __global short *filteredFrame, const int frameWidth, const int frameHeight, const int kernelIdx, const int rep){
...
__kernel void filterFrame_1d_int(__global short *referenceFrame, __global short *filteredFrame, const int frameWidth, const int frameHeight, const int kernelIdx, const int rep){
    ...
    // Each WG processes one CTU. It requires a halo of 1 sample around the input
    __local short origThenFinalQuarterCTU[130*34];
    __local unsigned int partialFilteredQuarterCTU[130*34];
...
__kernel void filterFrame_1d_int_5x5(__global short *referenceFrame, __global short *filteredFrame, const int frameWidth, const int frameHeight, const int kernelIdx, const int rep){   
    ...
    // Each WG processes one CTU. It requires a halo of 1 sample around the input
    __local short origThenFinalQuarterCTU[132*36];
    __local unsigned int partialFilteredQuarterCTU[132*36];
