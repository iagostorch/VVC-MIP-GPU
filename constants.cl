...
#define ALL_MAX_CUS_PER_CTU 128

#define ALL_TOTAL_CUS_PER_CTU 1156 // Sum of cusPerCtu for all CUs with all alignments
...
const unsigned char ALL_widths[28] = {
                                      // ALIGNED
                                      64,  // 64x64
                                      32,  // 32x32
                                      32,  // 32x16
...
const unsigned char ALL_heights[28] = {
                                    // ALIGNED
                                    64,  // 64x64
                                    32,  // 32x32
                                    16,  // 32x16
...
const unsigned char ALL_cusPerCtu[28] = {
                                    // ALIGNED
                                    4,   // 64x64
                                    16,  // 32x32
                                    32,  // 32x16
...
// Used to access the boundaries of a specific CU size inside the unified buffer
const unsigned short ALL_stridedCompleteTopBoundaries[29] = {
    // width * nCUs
    // ALIGNED
    0,                                                                        // 64x64
    0 + 4*64,                                                                 // 32x32
    ...
    8960 + 8960  // ALL_TOTAL_TOP_BOUNDARIES_PER_CTU
};

const unsigned short ALL_stridedCompleteLeftBoundaries[29] = {
    // height * nCUs
    // ALIGNED
    0,                                                                        // 64x64  
    0 + 4*64,                                                                 // 32x32
    ...
    8960 + 8960  // ALL_TOTAL_LEFT_BOUNDARIES_PER_CTU
};

const unsigned char ALL_cuColumnsPerCtu[28] = {
                                    // ALIGNED
                                    2   ,// 64x64
                                    4   ,// 32x32 
                                    4   ,// 32x16
...
const unsigned char ALL_cuRowsPerCtu[28] = {
                                    // ALIGNED
                                    2  ,// 64x64
                                    4  ,// 32x32 
                                    8  ,// 32x16
...
__constant unsigned char ALL_X_POS[28][128] = 
{
  // ALIGNED
  /* 64x64 */     {0, 64, 0, 64},
...
__constant unsigned char ALL_Y_POS[28][128] = 
{
  // ALIGNED
  /* 64x64 */     {0, 0, 64, 64},
...
// This is used as a stride when we must access information from multiple CU sizes in the same buffer
const unsigned short ALL_stridedCusPerCtu[29] = { 
    // ALIGNED
    0,                          // 64x64
    0+4,                        // 32x32
    0+4+16,                     // 32x16
    ...
    532+624                                                       // ALL TOTAL_CUS_PER_CTU = 1156
   };
